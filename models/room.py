...
class RoomState(Base):
    ...
    room_id = Column(UUID, ForeignKey("room.room_id"), nullable=False)
...
class RoomDoorState(Base):
    ...
    room_id = Column(UUID, ForeignKey("room.room_id"), nullable=False)
    door_state = Column(Enum(DoorStateEnum), nullable=False, index=True)
...
class RoomSmokeState(Base):
    ...
    room_id = Column(UUID, ForeignKey("room.room_id"), nullable=False)
    smoke_state = Column(Enum(SmokeState), nullable=False, index=True)
